...
class PlayerSnd(Process):
    ...
    """
    Classe que compoem o Player, envia requisicoes de recursos.
    ---------------------------------------------------------------------------
    * run == inicia o playerSnd.
    """
    ###########################################################################
    ## ATTRIBUTES                                                            ## 
    ###########################################################################
    ...
    ## SPECIAL METHODS                                                       ## 
    ###########################################################################
    def __init__(self, authToken, vmTypes):
        super(PlayerSnd, self).__init__();

        ## LOG:
        print 'Instanciando o componente de envio de requisicao';

        ## Token do player que sera utilizado para autenticar no Referee. Sem
        ## esse token o referee nao aceita requisicoes.
        self.__authToken = authToken;

        ## Dicionario com o tipo de maquinas virtuais q serao requisitadas ao
        ## Referee. 
